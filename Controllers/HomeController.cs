...
//I decided to skip the splash page, and display my web app in a single-page style.
        public IActionResult Index()
        {
            return RedirectToAction("Dashboard", "iLcwdMapper");
        }

        [HttpGet("EnterSplash")]
        public IActionResult EnterSplash()
        {
            return RedirectToAction("Dashboard", "iLcwdMapper");
        }
        ...
        public IActionResult LogIn(LoginUser login)
        {
            if(ModelState.IsValid)
            {
                ...
                return RedirectToAction("AdminPage", "iLcwdMapper");
            }
            else
            {
                return View("SignIn");
